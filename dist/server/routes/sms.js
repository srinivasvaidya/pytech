...
const smsRouter = express_1.Router();
exports.smsRouter = smsRouter;
smsRouter.post("/sendSMS", (request, response) => {
...
smsRouter.post("/getCustomerInfo", (request, response) => {
    let merchantBranchId = request.headers["merchantbranchid"];
    dbFactory.get()
        .then(function (conn) {
        // MerchantBranchId -> MerchantBranchId (MerchantBranch) ->  CitrineMerchantId (CitrineMerchantId)
...
//# sourceMappingURL=C:/Users/pytechnovm/Desktop/PYPRIME/Deploy14thNov2017Working26Nov/Deploy14thNov2017Working26Nov/dist/server/routes/sms.js.map