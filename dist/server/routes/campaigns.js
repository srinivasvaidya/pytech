...
const campaignsRouter = express_1.Router();
exports.campaignsRouter = campaignsRouter;
campaignsRouter.post("/", (request, response) => {
...
campaignsRouter.post("/search", (request, response) => {
...
campaignsRouter.post("/adddummy", (request, response) => {
...
function getSearchResults(searchTerm, page, totalRecords, merchantBranchId, cb) {
    dbFactory.get()
        ...
        req.query("select count(*) as totalCount from [dbo].[Campaign] " + wherequery)
            ...
            console.log("QUery is " + dbFactory.getPaginationQuery('Campaign', page, totalRecords, wherequery, " ORDER BY CampaignId"));
            req.query(dbFactory.getPaginationQuery('Campaign', page, totalRecords, wherequery, " ORDER BY CampaignId"))
                .then(function (recordset) {
                let data = {
...
//# sourceMappingURL=C:/Users/pytechnovm/Desktop/PYPRIME/Deploy14thNov2017Working26Nov/Deploy14thNov2017Working26Nov/dist/server/routes/campaigns.js.map