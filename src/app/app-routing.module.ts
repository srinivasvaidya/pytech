...
export const routes: Routes = [
  ...
  { 
    path: ':merchantBranchId/feedback/:custFeedbackId', 
...
export class AuthGuard implements CanActivate {
    constructor(private _authGuard: AuthGuard, private _appGlobals: AppGlobals, private router: Router) {}
    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Promise<boolean> {
      if(this._appGlobals.token.subscribe(value => {
