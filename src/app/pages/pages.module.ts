...
import { CampaignComponent, DeleteDialogComponent }               from './dashboard/campaigns/campaign.component';
import { CampaignSideNavbarComponent }     from './dashboard/campaigns/side-navbar/side-navbar.component';
import { CustomerSideNavbarComponent }     from './dashboard/customers/side-navbar/side-navbar.component';
import { TransactionSideNavbarComponent }   from './dashboard/transactions/side-navbar/side-navbar.component';
import { CampaignReportComponent }          from './dashboard/campaignsreport/campaign.report.component';
import { FileSelectDirective} from 'ng2-file-upload';

import { PageDashboardComponent }          from './dashboard/dashboard.component';
import { PageDashboard2Component }         from './dashboard-2/dashboard-2.component';
...
import { FeedBackQuestionsComponent } from './dashboard/feedback-questions/feedback-questions.component';
import { FeedBackComponent } from './dashboard/feedback/feedback.component';
import { CustomerFeedbacksComponent } from './dashboard/customerfeedbacks/customer-feedbacks.component';
import { CompleterCmpMd }                  from "./dashboard/transactions/ng2-completer-md/completer-cmp-md";
@NgModule({
  imports: [
    CommonModule,
    FormsModule,
  ...
  declarations: [
    ...
    CustomersComponent,
    CustomerSideNavbarComponent,
    CampaignComponent,
    DeleteDialogComponent,
    CampaignSideNavbarComponent,
    TransactionSideNavbarComponent,
